...
public class TradingSignalsService {
    ...
    // Пресметка на техничките индикатори на различни временски рамки
    ...
    // Пример за употреба на функцијата
    public static void main(String[] args) {
        ...
        TradingSignalsService service = new TradingSignalsService();
        Map<String, List<Double>> indicators = service.calculateIndicatorsForDifferentTimeFrames(prices);

        // Печатење на резултати за различни временски рамки
